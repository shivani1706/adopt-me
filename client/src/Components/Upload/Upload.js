...
export default function Upload() {
  return <div className='pet-image6 text-white mx-60 py-32 px-24  text-center px-9'>
      ...
      <div className='text-xl my-2 font-bold'>Upload the details here and help them find a new home <i class="fas fa-home"></i></div>
      <button className="rounded-full bg-purple-800 hover:bg-purple-300 px-4 py-2 mr-96 ml-96 my-6 font-semibold text-lg outline outline-offset-2 outline-purple-400 hover:outline-purple-800 hover:text-black">UPLOAD</button>
  </div>;
}
