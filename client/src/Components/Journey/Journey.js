...
export default function Journey() {
  return <div className="grid grid-cols-2  bgdogcolor justify-center items-center">
    ...
    <div className='mr-4 ml-0 text-xl'>
        <div className='text-3xl mt-4 mb-2 font-bold'><i class="fas fa-search"></i> Search Pet</div>
        <div className='mb-6'>Adopt a dog or cat who's right for you. Simply enter your city above to start your search.</div>
        <div className='text-3xl mt-4 mb-2 font-bold'><i class="fas fa-phone-volume"></i> Connect</div>
        ...
        <div className='text-3xl mt-4 mb-2 font-bold'><i class="far fa-kiss-wink-heart"></i> AdoptLove</div>
        ...
        <div className='text-3xl mt-4 mb-2 font-bold'><i class="fas fa-syringe"></i> Free Vet Consultation</div>
