...
const PetsByZipPage = ()=>{
    ...
    useEffect(()=>{
        // firebase.fetchPetsByZip(211004).then((pets)=>setPets(pets.docs));
        console.log("pets of 211004")
        firebase.fetchPetsByZip(params.pincode).then((pets)=>setPets(pets.docs));
        },[])
